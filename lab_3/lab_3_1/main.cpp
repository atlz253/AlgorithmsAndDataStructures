  ...
  int run(void)
  {
    while (true)
    {
      cout << "1. тест массива на 10 элементов" << endl
           ...
           << "6. тест массива с 10 повторными ключами" << endl
           << "7. тест массива с 100 повторными ключами" << endl
           << "8. тест массива с 500 повторными ключами" << endl
           << "9. тест массива с 1000 повторными ключами" << endl
           << "0. выход" << endl;
      cin >> choice;
